...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <link href="CustomCss/StyleSheet1.css" rel="stylesheet" />
     ...
     <br />
         ...
         <p> <asp:LinkButton ID="LinkButtonSearchStudent" runat="server" 
         ...
         </asp:LinkButton></p><%--Teacher end--%><%--Course start--%><p><asp:LinkButton ID="LinkButtonSearchCourse" runat="server"
             Height="40"
             Width="200"
             ForeColor="#FFFFFF"
             BackColor="#AA2222" 
          ...
          </asp:LinkButton></p><%--User end--%><%--UserRole start--%><p> <asp:LinkButton ID="LinkButtonUserRole" runat="server"
              Height="40"
              Width="200"
              ForeColor="#FFFFFF"
        ...
        </asp:LinkButton></p><%-- AttendanceRegistration end --%><%--AttendanceRegistration start--%><p> <asp:LinkButton ID="LinkButtonExamenPoints" runat="server"
          Height="40"
          Width="200"
          ForeColor="#FFFFFF"
        ...
        </asp:LinkButton></p><%-- AttendanceRegistration end --%></div></asp:Content>