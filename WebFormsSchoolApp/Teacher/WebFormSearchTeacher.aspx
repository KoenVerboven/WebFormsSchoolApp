          ...
          >
           <Columns>
               <asp:CommandField 
                   ...
                   />
               <asp:BoundField DataField="PersonId" HeaderText="Id" SortExpression="TeacheId" ItemStyle-Width="10%" />
               <asp:BoundField DataField="FullName" HeaderText="FullName" SortExpression="LastName" ItemStyle-Width="30%" />
